'''
    ...
    This script gets a user's Github username and lists out all the user's repositories along with the number of commits
    per repo.
'''
...
if __name__ == "__main__":
    ...
    repo_commits_object = construct_repo_commits_object(user_name)
    print_repo_commits(repo_commits_object)
